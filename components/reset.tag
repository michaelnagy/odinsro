<reset>
  ...
  <div class="row">
    ...
    <div class="col s5">
        <div class="card-panel grey lighten-5 z-depth-1 position">
          <div class="animated fadeInUp">
            <h5>Position Reset</h5>
            <hr>
            <table class="striped">
              <thead>
                <tr>
    ...
    <div class="col s5">
        <div class="card-panel grey lighten-5 z-depth-1 style">
          <div class="animated fadeInUp">
            <h5>Style Reset</h5>
            <hr>
            <table class="striped">
              ...
              <tbody>
                <tr each={char}>
                  <td>{name} <a onclick={stylereset} data-char-id={char_id} class=" char-id waves-effect waves-light btn right"><i class="material-icons left">redo</i>reset</a></td>
                </tr>
              </tbody>
            </table>
          </div>
